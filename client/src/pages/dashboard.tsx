...
import { ArrowRight, Leaf, PlayCircle, Users, TrendingUp, Sparkles } from "lucide-react";
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-white/50 backdrop-blur-sm border-white/20 shadow-sm hover:shadow-md transition-all">
          ...
          <CardContent>
            <div className="text-2xl font-bold font-serif text-primary">12 Days</div>
        ...
        <Card className="bg-white/50 backdrop-blur-sm border-white/20 shadow-sm hover:shadow-md transition-all">
          ...
          <CardContent>
            <div className="text-2xl font-bold font-serif text-primary">$340.50</div>
        ...
        <Card className="bg-white/50 backdrop-blur-sm border-white/20 shadow-sm hover:shadow-md transition-all">
          ...
          <CardContent>
            <div className="text-2xl font-bold font-serif text-primary">5 New</div>
            <p className="text-xs text-muted-foreground mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="bg-white/60 backdrop-blur-md border-white/40 shadow-soft">
          <CardHeader>
            ...
            <CardDescription>Based on your recent symptom checks</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {[
              { name: "Calm & Center", type: "Sleep Support", date: "Yesterday" },
              { name: "Digestive Ease", type: "Gut Health", date: "2 days ago" },
              { name: "Morning Focus", type: "Energy", date: "Last week" }
            ].map((item, i) => (
